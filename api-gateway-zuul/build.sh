...
# push 到 harbor 镜像仓库
docker tag api-gateway-zuul:latest 192.168.1.139:8080/micro-service/api-gateway-zuul:latest
docker push 192.168.1.139:8080/micro-service/api-gateway-zuul:latest